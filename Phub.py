...
#   For support https://t.me/TeLeTiPsOfficialOnTopicChat
...
async def start(_, message):
    m= await message.reply_text(
        text = "Hi Iam Tg_PHub_Bot.You can Download Videos from PornHub upto 1080p !"
       )
...
async def repo(_, message):
    m= await message.reply_text(
        text="""[Tg_PHub_Bot Repo](https://github.com/GhangaleSangram) | [Support Group](https://t.me/TeLeTiPsOfficialOnTopicChat)""",
